...
def send_sms(phone_number, msg):
    ...
    import json
    response = ""
    sid = 'AC718d7a9c15b1732f5f4af674372594c5'  #os.environ.get('SID')
    token = 'a5980a60b771a48e8e79bc1c3c4c190d' #os.environ.get('TOKEN')
    if sid is None or token is None:
        raise Exception("SID/Token cannot be Null")
